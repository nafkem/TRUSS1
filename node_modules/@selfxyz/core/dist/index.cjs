...
__export(index_exports, {
  ...
  SelfBackendVerifier: () => SelfBackendVerifier,
  countries: () => import_common.countries,
  countryCodes: () => import_constants4.countryCodes,
  getUniversalLink: () => import_appType.getUniversalLink
});
module.exports = __toCommonJS(index_exports);

// src/SelfBackendVerifier.ts
var import_ethers5 = require("ethers");
var import_scope = require("@selfxyz/common/utils/scope");
...
function calculateUserIdentifierHash(userContextData) {
  const sha256Hash = import_ethers4.ethers.sha256(userContextData);
  const ripemdHash = import_ethers4.ethers.ripemd160(sha256Hash);
  return ripemdHash.toString().padStart(40, "0");
}

// src/SelfBackendVerifier.ts
var import_uuid = require("@selfxyz/common/utils/circuits/uuid");
...
// src/utils/utils.ts
var import_formatOutputs = require("@selfxyz/common/utils/circuits/formatOutputs");
...
function unpackForbiddenCountriesList(forbiddenCountriesList_packed) {
  const trimmed = trimu0000((0, import_formatOutputs.unpackReveal)(forbiddenCountriesList_packed, "id"));
  const countries2 = [];
...
var SelfBackendVerifier = class {
  constructor(scope, endpoint, mockPassport = false, allowedIds, configStorage, userIdentifierType) {
    ...
    this.scope = (0, import_scope.hashEndpointWithScope)(endpoint, scope);
  ...
  async verify(attestationId, proof, pubSignals, userContextData) {
    ...
    const userIdentifier = (0, import_uuid.castToUserIdentifier)(
...
// index.ts
var import_constants4 = require("@selfxyz/common/constants/constants");
var import_appType = require("@selfxyz/common/utils/appType");
var import_common = require("@selfxyz/common");
