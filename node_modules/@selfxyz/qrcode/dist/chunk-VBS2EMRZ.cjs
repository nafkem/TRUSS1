...
var _chunkOHEJ4ULGcjs = require('./chunk-OHEJ4ULG.cjs');




var _chunkTQEMGLJAcjs = require('./chunk-TQEMGLJA.cjs');


var _chunk524GSCBOcjs = require('./chunk-524GSCBO.cjs');


var _chunkJJXEZUAKcjs = require('./chunk-JJXEZUAK.cjs');

// components/SelfQRcode.tsx
var _react = require('react'); var _react2 = _interopRequireDefault(_react);
var _reactspinners = require('react-spinners');
var _lottiereact = require('lottie-react'); var _lottiereact2 = _interopRequireDefault(_lottiereact);

// animations/check_animation.json with { type: 'json' }
...
// animations/x_animation.json with { type: 'json' }
...
var _constants = require('@selfxyz/common/constants/constants');
var _uuid = require('uuid');
var _qrcodereact = require('qrcode.react');



var _appType = require('@selfxyz/common/utils/appType');
var SelfQRcodeWrapper = (props) => {
  ...
  return /* @__PURE__ */ _react2.default.createElement(SelfQRcode, { ...props });
};
var SelfQRcode = ({
  selfApp,
  onSuccess,
  onError,
  type = "websocket",
  websocketUrl = _constants.WS_DB_RELAYER,
  size = 300,
  darkMode = false
}) => {
  const [proofStep, setProofStep] = _react.useState.call(void 0, _chunkJJXEZUAKcjs.QRcodeSteps.WAITING_FOR_MOBILE);
  const [proofVerified, setProofVerified] = _react.useState.call(void 0, false);
  const [sessionId, setSessionId] = _react.useState.call(void 0, "");
  const socketRef = _react.useRef.call(void 0, null);
  _react.useEffect.call(void 0, () => {
    setSessionId(_uuid.v4.call(void 0, ));
  }, []);
  _react.useEffect.call(void 0, () => {
    if (sessionId && !socketRef.current) {
      console.log("[QRCode] Initializing new WebSocket connection");
      socketRef.current = _chunk524GSCBOcjs.initWebSocket.call(void 0, 
        websocketUrl,
        {
          ...selfApp,
          sessionId
  ...
  const renderProofStatus = () => /* @__PURE__ */ _react2.default.createElement("div", { style: _chunkTQEMGLJAcjs.containerStyle }, /* @__PURE__ */ _react2.default.createElement("div", { style: _chunkTQEMGLJAcjs.ledContainerStyle }, /* @__PURE__ */ _react2.default.createElement(_chunkOHEJ4ULGcjs.LED_default, { connectionStatus: proofStep })), /* @__PURE__ */ _react2.default.createElement("div", { style: _chunkTQEMGLJAcjs.qrContainerStyle.call(void 0, size) }, (() => {
    switch (proofStep) {
      case _chunkJJXEZUAKcjs.QRcodeSteps.PROOF_GENERATION_STARTED:
      case _chunkJJXEZUAKcjs.QRcodeSteps.PROOF_GENERATED:
        return /* @__PURE__ */ _react2.default.createElement(_reactspinners.BounceLoader, { loading: true, size: 200, color: "#94FBAB" });
      case _chunkJJXEZUAKcjs.QRcodeSteps.PROOF_GENERATION_FAILED:
        return /* @__PURE__ */ _react2.default.createElement(
          _lottiereact2.default.default,
          {
      ...
      case _chunkJJXEZUAKcjs.QRcodeSteps.PROOF_VERIFIED:
        return /* @__PURE__ */ _react2.default.createElement(
          _lottiereact2.default.default,
          {
      ...
      default:
        return /* @__PURE__ */ _react2.default.createElement(
          _qrcodereact.QRCodeSVG,
          {
            value: type === "websocket" ? `${_constants.REDIRECT_URL}?sessionId=${sessionId}` : _appType.getUniversalLink.call(void 0, {
              ...selfApp,
              sessionId
            }),
            size,
  ...
  return /* @__PURE__ */ _react2.default.createElement("div", { style: _chunkTQEMGLJAcjs.containerStyle }, renderProofStatus());
};
...
exports.SelfAppBuilder = _appType.SelfAppBuilder; exports.SelfQRcodeWrapper = SelfQRcodeWrapper; exports.SelfQRcode = SelfQRcode;
