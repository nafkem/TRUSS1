...
exports.getSKIPEM = getSKIPEM;
const constants_js_1 = require("../constants/constants.js");
const skiPem_js_1 = require("../constants/skiPem.js");
...
function getCSCAFromSKI(ski, skiPem = null) {
    ...
    const cscaPemPROD = skiPem_js_1.SKI_PEM[normalizedSki];
    const cscaPemDEV = skiPem_js_1.SKI_PEM_DEV[normalizedSki];
    let cscaPem = null;
    if (isSkiProvided) {
...
async function getSKIPEM(environment) {
    const skiPemUrl = (environment === 'staging' ? constants_js_1.API_URL_STAGING : constants_js_1.API_URL) + '/ski-pem';
