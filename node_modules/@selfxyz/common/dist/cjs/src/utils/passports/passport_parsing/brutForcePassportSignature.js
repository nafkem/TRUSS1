...
const elliptic_js_1 = require("../../certificate_parsing/elliptic.js");
...
function brutforceSignatureAlgorithm(passportData) {
    const parsedDsc = (0, parseCertificateSimple_js_1.parseCertificateSimple)(passportData.dsc);
    ...
    for (const saltLength of constants_js_1.saltLengths) {
...
function verifyECDSA(passportData, hashAlgorithm) {
    ...
    const { publicKeyDetails } = (0, parseCertificateSimple_js_1.parseCertificateSimple)(dsc);
    ...
    const curveForElliptic = (0, curves_js_1.getCurveForElliptic)(publicKeyDetails.curve);
    const ec = new elliptic.ec(curveForElliptic);
    const key = ec.keyFromPublic(publicKeyBuffer);
    const msgHash = (0, hash_js_1.hash)(hashAlgorithm, signedAttr, 'hex');
...
function verifyRSA(passportData, hashAlgorithm) {
    ...
    const msgHash = (0, hash_js_1.hash)(hashAlgorithm, signedAttr, 'binary');
