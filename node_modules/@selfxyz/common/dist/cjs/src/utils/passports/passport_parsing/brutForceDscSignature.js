...
function brutforceHashAlgorithmDsc(dsc, csca, signatureAlgorithm, saltLength) {
    for (const hashFunction of constants_js_2.hashAlgos) {
...
function verifyECDSA(dsc, csca, hashAlgorithm) {
    ...
    const curveForElliptic_csca = (0, curves_js_1.getCurveForElliptic)(csca.publicKeyDetails.curve);
...
function getTBSHash(pem, hashFunction, format = 'data') {
    ...
    const msgHash = (0, hash_js_1.hash)(hashFunction, tbsBytesArray, format === 'hex' ? 'hex' : 'binary');
    return msgHash;
}
