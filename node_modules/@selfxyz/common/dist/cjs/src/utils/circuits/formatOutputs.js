...
function getAttributeFromUnpackedReveal(unpackedReveal, attribute, id_type) {
    const position = id_type === 'passport' ? constants_js_1.attributeToPosition[attribute] : constants_js_1.attributeToPosition_ID[attribute];
    let attributeValue = '';
...
function revealBitmapFromMapping(attributeToReveal) {
    ...
    Object.entries(attributeToReveal).forEach(([attribute, reveal]) => {
        if (reveal !== '') {
            const [start, end] = constants_js_1.attributeToPosition[attribute];
...
function revealBitmapFromAttributes(disclosureOptions, id_type) {
    ...
    const att_to_position = id_type === 'passport' ? constants_js_1.attributeToPosition : constants_js_1.attributeToPosition_ID;
