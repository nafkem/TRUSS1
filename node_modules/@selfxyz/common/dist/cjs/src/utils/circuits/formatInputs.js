...
function formatCountriesList(countries) {
    ...
    if (countries.length > constants_js_1.MAX_FORBIDDEN_COUNTRIES_LIST_LENGTH) {
        throw new Error(`Countries list must be inferior or equals to ${constants_js_1.MAX_FORBIDDEN_COUNTRIES_LIST_LENGTH}`);
    }
    ...
    const paddedCountries = countries.concat(Array(constants_js_1.MAX_FORBIDDEN_COUNTRIES_LIST_LENGTH - countries.length).fill(''));
