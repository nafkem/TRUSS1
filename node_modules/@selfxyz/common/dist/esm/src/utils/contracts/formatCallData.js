export function formatCallData_register(parsedCallData) {
    return {
...
export function formatCallData_dsc(parsedCallData) {
    return {
        blinded_dsc_commitment: parsedCallData[3][0],
...
export function formatCallData_disclose(parsedCallData) {
    return {
...
export function packForbiddenCountriesList(forbiddenCountries) {
