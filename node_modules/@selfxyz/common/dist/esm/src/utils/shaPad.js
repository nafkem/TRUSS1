...
export function shaPad(prehash_prepad_m_array, maxShaBytes) {
...
export function sha384_512Pad(prehash_prepad_m_array, maxShaBytes) {
    let prehash_prepad_m = new Uint8Array(prehash_prepad_m_array);
...
export function int64toBytes(num) {
