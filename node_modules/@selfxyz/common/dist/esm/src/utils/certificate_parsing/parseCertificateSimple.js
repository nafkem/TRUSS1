...
export function parseCertificateSimple(pem) {
    let certificateData = {
        id: '',
        issuer: '',
        validity: {
...
export function getParamsECDSA(cert) {
    try {
...
export const getAuthorityKeyIdentifier = (cert) => {
...
export const getCircuitName = (circuitMode, signatureAlgorithm, hashFunction, domainParameter, keyLength) => {
...
export const getCircuitNameOld = (circuitMode, signatureAlgorithm, hashFunction) => {
    const circuit = circuitNameFromMode[circuitMode];
    if (circuit == 'vc_and_disclose') {
        return 'vc_and_disclose';
    }
...
export function getHashAlgorithm(rawSignatureAlgorithm) {
...
export function getCertificateFromPem(pemContent) {
...
export function getTBSBytesForge(certificate) {
