...
export function identifyCurve(params) {
...
export function getECDSACurveBits(curveName) {
    const curveBits = {
        secp224r1: 224,
        secp256r1: 256,
        secp384r1: 384,
...
export function getCurveForElliptic(curveName) {
    const curves = {
        secp224r1: 'p224',
        secp256r1: 'p256',
        secp384r1: 'p384',
