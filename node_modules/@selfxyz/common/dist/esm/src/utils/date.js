export function getAdjustedTimestampBytes(y = 0, m = 0, d = 0) {
...
export function getTimestampBytesFromYearFraction(yearFraction) {
...
export function unixTimestampToYYMMDD(timestamp) {
...
export function yearFractionToYYMMDD(yearFraction) {
    // Separate the year and the fractional part
