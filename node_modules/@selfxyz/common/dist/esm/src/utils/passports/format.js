...
export function formatAndConcatenateDataHashes(dataHashes, dg1HashOffset) {
...
export function generateSignedAttr(messageDigest) {
...
export function formatDg2Hash(dg2Hash) {
...
export function formatDG1Attribute(index, value) {
...
export function formatName(firstName, lastName, targetLength) {
