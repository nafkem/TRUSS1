...
export function brutforceSignatureAlgorithmDsc(dsc, csca) {
...
function verifyECDSA(dsc, csca, hashAlgorithm) {
    ...
    const curveForElliptic_csca = getCurveForElliptic(csca.publicKeyDetails.curve);
...
export function getTBSHash(pem, hashFunction, format = 'data') {
