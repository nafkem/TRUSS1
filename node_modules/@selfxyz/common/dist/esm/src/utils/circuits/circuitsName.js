export function getCircuitNameFromPassportData(passportData, circuitType) {
...
function getRegisterNameFromPassportData(passportData) {
    ...
    const prefix = passportData.documentType === 'id_card' || passportData.documentType === 'mock_id_card'
        ? 'register_id'
        : 'register';
    if (sigAlg === 'ecdsa') {
        console.log('Processing ECDSA signature...');
