...
export function formatForbiddenCountriesListFromCircuitOutput(forbiddenCountriesList) {
...
export function getAttributeFromUnpackedReveal(unpackedReveal, attribute, id_type) {
...
export function unpackReveal(revealedData_packed, id_type) {
...
export function getOlderThanFromCircuitOutput(olderThan) {
    const ageString = olderThan.map((code) => String.fromCharCode(parseInt(code))).join('');
    const age = parseInt(ageString, 10);
    return isNaN(age) ? 0 : age;
}
export function formatAndUnpackReveal(revealedData_packed, id_type) {
    ...
    return unpackReveal(id_type === 'passport'
        ? revealedData_packed_formatted_passport
        : revealedData_packed_formatted_id, id_type);
}
export function formatAndUnpackForbiddenCountriesList(forbiddenCountriesList_packed) {
...
export function revealBitmapFromMapping(attributeToReveal) {
...
export function revealBitmapFromAttributes(disclosureOptions, id_type) {
