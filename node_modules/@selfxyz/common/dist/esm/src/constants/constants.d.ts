...
export declare const CSCA_TREE_URL_ID_CARD = "https://tree.self.xyz/csca-id";
export declare const DSC_TREE_URL_ID_CARD = "https://tree.self.xyz/dsc-id";
export declare const CSCA_TREE_URL_STAGING_ID_CARD = "https://tree.staging.self.xyz/csca-id";
export declare const DSC_TREE_URL_STAGING_ID_CARD = "https://tree.staging.self.xyz/dsc-id";
export declare const IDENTITY_TREE_URL_ID_CARD = "https://tree.self.xyz/identity-id";
export declare const IDENTITY_TREE_URL_STAGING_ID_CARD = "https://tree.staging.self.xyz/identity-id";
export declare const PASSPORT_ATTESTATION_ID = "1";
export declare const ID_CARD_ATTESTATION_ID = "2";
...
export declare const attributeToPosition_ID: {
    issuing_state: number[];
    name: number[];
    passport_number: number[];
    nationality: number[];
